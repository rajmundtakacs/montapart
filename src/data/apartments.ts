...
export const apartments: Apartment[] = [
    ...
    units: [
      {
        ...
        bathrooms: 2,
        seaDistance: '0 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mikró', 'Vízforraló', 'Parkoló'],
    ...
    units: [
      {
        ...
        bathrooms: 1,
        seaDistance: '500 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosógép', 'Mosogatógép', 'Mikró', 'Vízforraló', 'Parkoló'],
      ...
      },
      {
        ...
        bathrooms: 1,
        seaDistance: '500 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosógép', 'Mikró', 'Vízforraló', 'Parkoló'],
      ...
      },
      {
        ...
        bathrooms: 1,
        seaDistance: '500 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosogatógép', 'Mikró', 'Vízforraló', 'Parkoló'],
    ...
    units: [
      {
        ...
        bathrooms: 1,
        seaDistance: '110 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosogatógép', 'Mikró', 'Vízforraló'],
      ...
      },
      {
        ...
        bathrooms: 1,
        seaDistance: '110 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mikró', 'Vízforraló'],
  ...
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        bathrooms: 1,
        seaDistance: '80 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosógép', 'Mikró', 'Vízforraló'],
    ...
    units: [
      {
        ...
        bathrooms: 1,
        seaDistance: '',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosógép', 'Mikró'],
    ...
    units: [
      {
        ...
        bathrooms: 1,
        seaDistance: '400 m',
        amenities: ['Internet', 'Klíma', 'Mosógép', 'Mikró', 'Vízforraló'],
  ...
  },
  {
    ...
    name: 'Teszt apartman',
    description:
      'Ez egy teszt apartman az összes adat megjelenítésének ellenőrzéséhez. Minden mező ki van töltve, minden felszereltség szerepel.',
    thumbnail: '/images/apartmanok/lugas/thumbnail.JPG',
    units: [
      {
        id: 1,
        ...
        seaDistance: '50 m',
        amenities: ['Internet', 'Klíma', 'TV', 'Mosógép', 'Mosogatógép', 'Mikró', 'Vízforraló', 'Parkoló'],
        images: generateImages('/images/apartmanok/lugas/ap1', 'lugas', 5),
      },
      {
        id: 2,
        label: 'Apartman 2',
        ...
        bathrooms: 1,
        seaDistance: '50 m',
        amenities: ['Internet', 'Klíma', 'TV'],
        images: generateImages('/images/apartmanok/kek/images/ap2', 'kek', 5, 'JPG'),
      },
    ],
  },
];
